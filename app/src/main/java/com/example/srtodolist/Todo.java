...
public class Todo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        srUser = srAuth.getCurrentUser();
        onlineUserID = srUser.getUid();
        reference = FirebaseDatabase.getInstance("https://sr-todo-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference().child("tasks").child(onlineUserID);
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setDate(String date) {
            TextView dateTectView = mView.findViewById(R.id.dateTv);
            dateTectView.setText(date);
        }
    }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.logout:
                srAuth.signOut();
                Intent intent  = new Intent(Todo.this, loginActivity.class);
